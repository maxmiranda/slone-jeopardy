...
const serverFromQuery = urlSearch.get('server');
export const serverPath =
  // Highest priority: explicit server query param, e.g. ?server=https://myhost.com
  serverFromQuery ||
  // Build-time override for static hosting (Firebase, etc.)
  import.meta.env.VITE_SERVER_HOST ||
  // Fallback: same host, with dev port if not production
